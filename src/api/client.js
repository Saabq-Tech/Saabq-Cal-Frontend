...
const API_BASE = (import.meta.env.VITE_API_BASE_URL || 'https://admin.cal.saabq.com') + '/api/v1';
...
export const endpoints = {
  ...
  publicWorkspaceServices: (idOrSlug) => `/customers/workspaces/${idOrSlug}/services`,
  publicWorkspaceSlots: (idOrSlug, serviceId) => `/customers/workspaces/${idOrSlug}/services/${serviceId}/slots`,
  ...
  passkeysRegisterOptions: (type) => `${getAuthPrefix(type)}/passkeys/register-options`,
  passkeysRegister: (type) => `${getAuthPrefix(type)}/passkeys/register`,
  passkeysDelete: (type, id) => `${getAuthPrefix(type)}/passkeys/${id}`,
  passkeysLoginOptions: (type) => `${getAuthPrefix(type)}/auth/passkeys/login-options`,
  ...
  workspaceSettingsTimezone: '/workspace-members/workspace/settings/timezone-and-format',
  workspaceSettingsSocial: '/workspace-members/workspace/settings/social-links',
  workspaceSettingsBookingRules: '/workspace-members/workspace/settings/booking-rules',
  workspaceSettingsBookingForm: '/workspace-members/workspace/settings/booking-form-fields',
  workspaceSettingsPayment: '/workspace-members/workspace/settings/payment-receipts',
  workspaceSettingsNotifications: '/workspace-members/workspace/settings/notification-templates',
  ...
  workspaceBookingStatus: (id) => `/workspace-members/workspace/bookings/${id}/status`,
