...
const CustomerWorkspacesPage = lazy(
  () => import("./pages/customer/CustomerWorkspacesPage"),
);
const CustomerWorkspaceProfilePage = lazy(
  () => import("./pages/customer/CustomerWorkspaceProfilePage"),
);
...
const CustomerVerifyAccountPage = lazy(
  () => import("./pages/customer/auth/CustomerVerifyAccountPage"),
);
...
const MemberRegisterPage = lazy(
  () => import("./pages/member/auth/MemberRegisterPage"),
);
const MemberForgotPasswordPage = lazy(
  () => import("./pages/member/auth/MemberForgotPasswordPage"),
);
const MemberVerifyAccountPage = lazy(
  () => import("./pages/member/auth/MemberVerifyAccountPage"),
);
const MemberProfilePage = lazy(
  () => import("./pages/member/dashboard/MemberProfilePage"),
);
const MemberSecurityPage = lazy(
  () => import("./pages/member/dashboard/MemberSecurityPage"),
);
...
const WorkspaceSubscriptionsPage = lazy(
  () => import("./pages/member/dashboard/WorkspaceSubscriptionsPage"),
);
const WorkspaceMembersPage = lazy(
  () => import("./pages/member/dashboard/WorkspaceMembersPage"),
);
const WorkspaceRolesPage = lazy(
  () => import("./pages/member/dashboard/WorkspaceRolesPage"),
);
const WorkspaceServicesPage = lazy(
  () => import("./pages/member/dashboard/WorkspaceServicesPage"),
);
...
const ServiceUnavailablePage = lazy(
  () => import("./pages/error/ServiceUnavailablePage"),
);
              ...
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  >
                    ...
                    <Route
                      path="subscriptions"
                      element={<WorkspaceSubscriptionsPage />}
                    />
                    <Route path="members" element={<WorkspaceMembersPage />} />
                    <Route path="roles" element={<WorkspaceRolesPage />} />
                    <Route
                      path="services"
                      element={<WorkspaceServicesPage />}
                    />
                    <Route
                      path="bookings"
                  ...
                  <Route
                    ...
                    element={
                      <GuestRoute>
                        <Navigate to="/customer/register" replace />
                      </GuestRoute>
                    }
                  />
                  <Route
                    ...
                    element={
                      <GuestRoute>
                        <Navigate to="/customer/forgot-password" replace />
                      </GuestRoute>
                    }
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={
                      <GuestRoute>
                        <Navigate to="/customer/verify-account" replace />
                      </GuestRoute>
                    }
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={
                      <Navigate to="/member/workspace/settings" replace />
                    }
                  />
                  <Route
                    path="/workspace/subscriptions"
                    element={
                      <Navigate to="/member/workspace/subscriptions" replace />
                    }
                  />
                  <Route
                    path="/workspace/members"
                    element={
                      <Navigate to="/member/workspace/members" replace />
                    }
                  />
                  <Route
                    path="/workspace/roles"
                    element={<Navigate to="/member/workspace/roles" replace />}
                  />
                  <Route
                    path="/workspace/services"
                    element={
                      <Navigate to="/member/workspace/services" replace />
                    }
                  />
                  <Route
                    path="/workspace/bookings"
                    element={
                      <Navigate to="/member/workspace/bookings" replace />
                    }
                  />
                  <Route
