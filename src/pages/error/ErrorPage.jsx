    ...
    return (
      <div className="error-illustration-wrapper">
        ...
        >
          ...
          />
          <path
            d="M80 30L125 50V90C125 117.6 105.8 143.2 80 150C54.2 143.2 35 117.6 35 90V50L80 30Z"
            fill="url(#warning-grad)"
            opacity="0.15"
          />
          <path
            d="M80 34L120 52V88C120 112.8 102.8 135.8 80 142C57.2 135.8 40 112.8 40 88V52L80 34Z"
            stroke="var(--warning)"
            strokeWidth="4"
          ...
          />
          <path
            d="M68 76V66C68 59.3726 73.3726 54 80 54C86.6274 54 92 59.3726 92 66V76"
            stroke="var(--warning)"
            strokeWidth="4"
            strokeLinecap="round"
          />
    ...
    return (
      <div className="error-illustration-wrapper">
        ...
        >
          ...
          <path
            d="M119 106L109 119H118L116 129L127 116H118L119 106Z"
            fill="#FFFFFF"
          />
        </svg>
      </div>
    ...
    return (
      <div className="error-illustration-wrapper">
        ...
        >
          ...
          {/* Wrench */}
          <path
            d="M102 45L120 63L110 73L92 55L102 45Z"
            fill="var(--secondary)"
          />
          <path
            d="M52 115L95 72"
            ...
            <div className="error-actions">
              ...
              {onRetry ? (
                <button
                  type="button"
                  onClick={onRetry}
                  className="btn btn-secondary btn-lg error-action-btn"
                >
                  <svg
                    className="icon-sm"
                    viewBox="0 0 24 24"
                ...
                <button
                  type="button"
                  onClick={() => navigate(-1)}
                  className="btn btn-outline btn-lg error-action-btn"
                >
                  <svg
                    className="icon-sm"
                    viewBox="0 0 24 24"
              ...
              <Link
                to="/workspaces"
                className="btn btn-ghost btn-lg error-action-btn"
              >
                <svg
                  className="icon-sm"
                  viewBox="0 0 24 24"
