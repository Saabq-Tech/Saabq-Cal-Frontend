...
export default function WorkspaceProfilePage() {
  ...
  return (
    ...
    >
      <SEO
        ...
        description={stripHtml(
          workspace.booking_short_intro ||
            ...
            (isRTL
              ? `احجز أفضل الخدمات والمواعيد لدى ${workspace.name}`
              : `Book top services and appointments at ${workspace.name}`),
        )}
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to top, rgba(15, 23, 42, 0.85) 0%, rgba(15, 23, 42, 0.25) 60%, transparent 100%)",
            pointerEvents: "none",
          }}
        />
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 280 }}>
              ...
              >
                {workspace.booking_short_intro ||
                  stripHtml(workspace.description) ||
                  (isRTL
            ...
            >
              <button
                ...
                onClick={() => {
                  ...
                  const el = document.getElementById("workspace-landing-tabs");
      ...
      <div id="workspace-landing-tabs" className="container">
        {/* Navigation Bar */}
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          >
            ...
            <span
              style={{
                ...
                color: activeTab === "services" ? "#fff" : "var(--text)",
                padding: "2px 8px",
                borderRadius: 999,
              }}
            >
          ...
          {specialistRoles.length > 0 && (
            ...
            >
              ...
              <span>{isRTL ? "فريق المتخصصين" : "Specialists & Team"}</span>
              <span
                style={{
                  fontSize: "0.78rem",
                  background:
                    activeTab === "specialists"
                      ? primaryColor
                      : "var(--surface-alt, #e2e8f0)",
                  color: activeTab === "specialists" ? "#fff" : "var(--text)",
                  padding: "2px 8px",
                  borderRadius: 999,
                }}
              >
            ...
            style={{
              ...
              borderBottom:
                activeTab === "about"
                  ...
                  : "3px solid transparent",
              color:
                activeTab === "about" ? primaryColor : "var(--text-secondary)",
              cursor: "pointer",
              display: "inline-flex",
              alignItems: "center",
              gap: 8,
          ...
          >
            ...
            <span>
              {isRTL ? "عن مساحة العمل والمواعيد" : "About & Schedule"}
            </span>
          </button>
          ...
          >
            ...
            <span>{isRTL ? "التواصل والموقع" : "Contact & Location"}</span>
          </button>
        </div>
          ...
          <section style={{ marginBottom: 60 }}>
            ...
            >
              <div>
                ...
                >
                  {t("offeredServices") ||
                    (isRTL ? "الخدمات المتاحة للحجز" : "Services Offered")}
                </h2>
                <p
                  style={{
                    color: "var(--text-secondary)",
                ...
                >
                  {isRTL
                    ...
                    : "Select a service and click 'Book Appointment' to pick your time slot."}
                </p>
              </div>
          ...
          <section style={{ marginBottom: 60 }}>
            ...
            {specialistRoles.length === 0 ? (
              ...
              >
                <p>
                  {isRTL
                    ? "لا يوجد متخصصون معروضون حالياً."
            ...
            >
              ...
              >
                ...
                >
                  ...
                  />
                  <span>
                    {isRTL ? "نبذة عن مساحة العمل" : "About Workspace"}
                  </span>
                </h3>
      ...
      >
        <div className="container">
          ...
          >
            <div
              className="card"
              style={{ padding: 24, borderRadius: 20, textAlign: "center" }}
            >
              <div
                style={{
                  width: 54,
      ...
      >
        <div
          className="container"
          style={{ textAlign: "center", relative: "z-index: 2" }}
        >
          <h2 style={{ fontSize: "2rem", fontWeight: 800, marginBottom: 12 }}>
            {isRTL
              ? `جاهز لحجز موعدك لدى ${workspace.name}؟`
              : `Ready to book your appointment at ${workspace.name}?`}
          </h2>
          <p
            style={{
              fontSize: "1.1rem",
