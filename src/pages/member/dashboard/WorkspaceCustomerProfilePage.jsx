...
export default function WorkspaceCustomerProfilePage() {
  ...
  return (
    <CapabilityGate capabilityCode="CUSTOMERS">
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            <span>
              {t("tabWorkspaceData") || "الملاحظات والبيانات الداخلية"}
            </span>
          </button>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {Array.isArray(apt.answers) &&
                          apt.answers.length > 0 && (
                            <div
                              style={{
                                marginTop: 12,
                                paddingTop: 10,
