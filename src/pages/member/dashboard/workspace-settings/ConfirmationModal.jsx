      ...
      >
        <div className="modal-header">
          <h3
            ...
            style={{ color: modalState.isDanger ? 'var(--error, #ef4444)' : 'var(--heading)', display: 'flex', alignItems: 'center', gap: 8 }}
          >
            {modalState.isDanger && (
          ...
          <button type="button" className="modal-close-btn" onClick={onClose} aria-label="إغلاق / Close">
            <Icon name="x" size={16} />
          </button>
        </div>
