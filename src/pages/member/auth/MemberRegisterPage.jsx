  ...
  return (
    <AuthCardLayout
      ...
      illustrationAlt={
        lang === "ar"
          ? "إنشاء حساب عضو فريق"
          : "Member registration illustration"
      }
      quote={
        lang === "ar"
    ...
    >
      ...
      <form className="auth-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group animate-fade-in-up">
          <label className="form-label" htmlFor="workspace_name">
            {t("workspaceName")}
          </label>
          <input
            id="workspace_name"
            ...
            aria-required="true"
            aria-describedby={
              errors.workspace_name ? "workspace_name-error" : undefined
            }
          />
          {errors.workspace_name && (
            <span id="workspace_name-error" className="form-error" role="alert">
      ...
      <div className="auth-footer">
        {t("alreadyHaveAccount")} <Link to="/member/login">{t("signIn")}</Link>
      </div>
    </AuthCardLayout>
  );
}
