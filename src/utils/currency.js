 ...
 */
export function formatCurrency(amount, currency = 'SAR', isRTL = true, freeLabel = null) {
  ...
  if (typeof currency === 'object' && currency !== null) {
    ...
    const nameStr = typeof detail.name === 'object'
      ? (isRTL ? detail.name?.ar || detail.name?.en : detail.name?.en || detail.name?.ar)
      : detail.name;
    symbol = (isRTL ? (detail.symbol_native || detail.symbol) : (detail.symbol || detail.symbol_native)) || nameStr || detail.code || '';
