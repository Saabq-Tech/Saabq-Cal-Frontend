...
export default function InstallAppButton({ className = '', style = {}, ...props }) {
  ...
  return (
    <>
      ...
      {isModalOpen && (
        <div 
          style={{ position: 'fixed', inset: 0, zIndex: 9999, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, direction: isRtl ? 'rtl' : 'ltr' }} 
          onClick={() => setIsModalOpen(false)}
        >
          <div 
            style={{ background: 'var(--surface)', borderRadius: 'var(--radius-lg)', padding: 24, maxWidth: 400, width: '100%', boxShadow: 'var(--shadow-xl)', textAlign: 'center', border: '1px solid var(--border)' }} 
          ...
          >
            ...
            <div style={{ marginBottom: 24, display: 'flex', justifyContent: 'center' }}>
              <div style={{ width: 64, height: 64, borderRadius: 16, background: 'var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--primary)' }}>
                <Icon name="smartphone" size={32} />
              </div>
            </div>
            
            <p style={{ marginBottom: 24, color: 'var(--text)', fontSize: '0.95rem', lineHeight: 1.6 }}>
              {t('installAppDesc') || 'Install our application on your device for a faster, full-screen experience and quick access from your home screen.'}
            </p>
