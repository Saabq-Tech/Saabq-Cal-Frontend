        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/register">{t('getStarted')}</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            {subscribed ? (
              <div role="status" aria-live="polite" style={{ padding: '10px 14px', borderRadius: 'var(--radius-md)', background: 'var(--primary-subtle)', color: 'var(--primary)', fontWeight: 600, fontSize: '0.85rem' }}>
                ✓ {t('newsletterSuccess')}
              </div>
            ) : (
