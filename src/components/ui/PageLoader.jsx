    ...
    >
      <div
        style={{
          ...
          background:
            "linear-gradient(90deg, #0a9099 0%, #166992 40%, #44f2fe 100%)",
...
export default function PageLoader({
  ...
  const subtitle = isRTL
    ? "منصة الجدولة وإدارة المواعيد الذكية"
        ...
        >
          ...
          <div
            style={{
              ...
              padding: 3,
              background:
                "conic-gradient(from 0deg, var(--primary), var(--secondary), #1739a5, var(--primary))",
              WebkitMask:
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "linear-gradient(135deg, rgba(17, 100, 106, 0.2) 0%, rgba(232, 141, 34, 0.2) 100%)",
              boxShadow:
                "0 0 32px rgba(17, 100, 106, 0.4), inset 0 0 16px rgba(232, 141, 34, 0.2)",
          ...
          <div
            style={{
              ...
              boxShadow:
                "0 6px 20px rgba(0, 0, 0, 0.12), inset 0 0 0 1px var(--border)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              padding: 10,
