...
export default function AppLogo({ height = 36, showText = true, className = '' }) {
  ...
  return (
    <div className={`app-logo-wrapper ${className}`} style={{ display: 'inline-flex', alignItems: 'center', gap: 10 }}>
      {!imgError ? (
        <img
          src={logoUrl}
          alt={siteName}
        ...
        <svg width={height} height={height} viewBox="0 0 32 32" fill="none">
          ...
          <path d="M8 16c0-4.418 3.582-8 8-8s8 3.582 8 8-3.582 8-8 8" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" />
