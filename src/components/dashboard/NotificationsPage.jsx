    ...
    <div className="notif-confirm-overlay" onClick={onCancel}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
          ...
          <h3 id="clear-notif-modal-title" style={{ fontSize: '1rem', fontWeight: 700, color: 'var(--text)', margin: 0 }}>
            {t('confirmClearTitle')}
          </h3>
        </div>
    ...
    >
      ...
      <div className="notif-content">
        ...
        <div className="notif-meta">
          <span className="notif-time">{relativeTime(notif.created_at, t)}</span>
          {isUnread && (
...
export default function NotificationsPage() {
  ...
  const fetchNotifications = useCallback(async (page = 1, append = false) => {
    ...
    try {
      const res = await client.get(endpoints.notifications, { params: { per_page: 15, page } });
    ...
    <>
      ...
      <div className="card animate-fade-in-up">
        <div className="card-header" style={{ borderBottom: '1px solid var(--border-light)', paddingBottom: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            {canClear && (
              <button
                className="btn btn-sm"
                style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(239,68,68,0.08)', color: '#ef4444', border: '1px solid rgba(239,68,68,0.25)' }}
        ...
        <div className="card-body" style={{ paddingTop: 16 }}>
          {/* Filter tabs */}
          <div className="notif-filter-tabs" role="tablist" aria-label={t('notificationsInboxTitle')} style={{ marginBottom: 20 }}>
            <button
              type="button"
              role="tab"
